...
render()
{
    return(
        ...
        <div className="channelsRows">
            <div>
                <h3>EARTH</h3>
                <img src={require("../assets/earth.jpeg")} alt="biology" />
                <p>The Deep Time of Walden Pond</p>
                <p>by Curt Stager</p>
            </div>
            <div>
                <h3>THINK LIKE A SCIENTIST</h3>
                <img src ={require("../assets/tlas.jpeg")} alt="woman" />
            ...
            <div>
                <h3>cosmos</h3>
                <img src ={require("../assets/cosmos.jpeg")} alt="woman" />
        ...
        <div className="channelsRows">
            <div>
                ...
                <img src={require("../assets/poetry.jpeg")} alt="biology" />
                <p>On Observation and Imagination</p>
                <p>by Gillian Osborne</p>
            </div>
            <div>
                <h3>Aging</h3>
                <img src ={require("../assets/aging.png")} alt="woman" />
                <p>Yes, Life in the Fast Lane Kills You</p>
                <p>by Philip Ball</p>
            </div>
            <div>
                <h3>SCIENCE PHILANTHROPY ALLIANCE</h3>
                <img src ={require("../assets/alliance.png")} alt="woman" />
        ...
        <div className="channelsRows">
            <div>
                <h3>MPNeuro</h3>
                <img src ={require("../assets/maxplanck.jpeg")} alt="woman" />
